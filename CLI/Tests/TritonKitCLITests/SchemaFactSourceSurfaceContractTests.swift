...
extension SchemaFactSourceTests {
    ...
    func executionAndEvidenceSchemasExposeRecoveryCommandsAndOutputContracts() throws {
        ...
        expectContract(replay, selector: "replay.result", fields: [
            ...
            "recoveryProposal", "recoveryProposal.schemaVersion", "recoveryProposal.kind", "recoveryProposal.trigger",
            "recoveryProposal.planName", "recoveryProposal.failedStepIndex", "recoveryProposal.failureCode",
            "recoveryProposal.workflowCategories", "recoveryProposal.recoveryCategories",
            "recoveryProposal.diagnosis", "recoveryProposal.diagnosis.type", "recoveryProposal.diagnosis.phase",
            "recoveryProposal.diagnosis.message", "recoveryProposal.diagnosis.hint", "recoveryProposal.diagnosis.endpoint",
            "recoveryProposal.diagnosis.evidenceRefs",
            "recoveryProposal.proposal", "recoveryProposal.proposal.action", "recoveryProposal.proposal.reason",
            "recoveryProposal.proposal.policyDecision", "recoveryProposal.proposal.command",
            "recoveryProposal.nextActions", "recoveryProposal.nextActions[].code",
            "recoveryProposal.nextActions[].message", "recoveryProposal.nextActions[].command",
            "recoveryProposal.nextActions[].category", "recoveryProposal.evidenceRefs",
