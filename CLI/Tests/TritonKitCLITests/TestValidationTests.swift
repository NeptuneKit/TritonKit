...
struct TestValidationTests {
    ...
    func testCommandSchemaExposesDeterministicRunContract() throws {
        ...
        #expect(schema.failureCodes.contains("reliability_identity_chain_write_failed"))
        ...
        #expect(failureShape.contains("collection-lease"))
        #expect(failureShape.contains("typed result then exits 1"))
        #expect(failureShape.contains("frozen failure taxonomy"))
        #expect(failureShape.contains("exact frozen deterministic assertion failure type"))
        ...
        #expect(sample.failureCodes.contains("reliability_identity_chain_write_failed"))
