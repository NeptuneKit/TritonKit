...
struct WebViewRouteTests {
    ...
    @Test("tap schema describes eligibility-checked collection and table selection")
    func tapSchemaDescribesEligibilityCheckedCollectionSelection() throws {
        ...
        #expect(actStrategy.description.contains("collection_cell_selection_blocked"))
        #expect(tapStrategy.description.contains("collection_cell_selection_denied"))
        ...
        #expect(tap.failureCodes.contains("collection_cell_selection_blocked"))
        #expect(tap.failureCodes.contains("collection_cell_selection_denied"))
        #expect(act.failureCodes.contains("collection_cell_selection_blocked"))
        #expect(act.failureCodes.contains("collection_cell_selection_denied"))
        #expect(tap.outputSemantics?.contains("verification.required=true") == true)
