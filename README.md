...
triton workspace run --target booted --platform ios --scope simulator --app com.example.app --goal "Open dashboard" --llm-provider mock --vlm-provider mock --execute-actions --observe-live --business-ready-text Dashboard --business-ready-live-wait --max-steps 2 --json
