...
func runtimeCapabilityGroup(for name: String) -> String {
    ...
    case "route-current-url-assert":
        return "route"
    case "capture", "evidence", "evidence-summary", "evidence-redact", "network-capture-export":
        return "evidence"
