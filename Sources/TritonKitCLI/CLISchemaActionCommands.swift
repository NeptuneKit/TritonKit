...
func actionCommandSchemas() -> [TKCommandSchema] {
    ...
    return [
        ...
        TKCommandSchema(
            ...
            outputSemantics: "Use tap after find when targets are ambiguous. Embedded iOS smart/ancestor activation can select UITableViewCell or UICollectionViewCell ancestors and reports strategy=ancestor-table-cell-selection or strategy=ancestor-collection-cell-selection. Follow successful taps with wait/assert and capture evidence on failure.",
            nextCommands: [
                "triton status --json",
