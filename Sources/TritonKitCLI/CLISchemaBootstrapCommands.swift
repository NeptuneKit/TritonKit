    ...
    return [
        ...
        TKCommandSchema(
            ...
            examples: [
                ...
                "triton plan network-proxy --platform android --device emulator-5554 --proxy 127.0.0.1:19431 --mode mock --output /tmp/proxy-session --certificate /tmp/triton-proxy-ca.cer --evidence /tmp/proxy.tritonevidence --json",
