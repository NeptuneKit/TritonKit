    ...
    return [
        ...
        TKCommandSchema(
            ...
            options: hostPort + [
                ...
                TKCommandSchemaOption(name: "--audit-record", type: "String", description: "Audit record id used by network-proxy certificate install break-glass plan steps"),
            ...
            examples: [
                ...
                "triton plan network-proxy --platform android --device emulator-5554 --proxy 127.0.0.1:19431 --mode mock --output /tmp/proxy-session --certificate /tmp/triton-proxy-ca.cer --audit-record ticket-123 --evidence /tmp/proxy.tritonevidence --json",
