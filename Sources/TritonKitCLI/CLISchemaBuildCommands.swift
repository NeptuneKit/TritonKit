    ...
    return [
        TKCommandSchema(
            ...
            options: [
                ...
                TKCommandSchemaOption(name: "--node", type: "Path", description: "Node executable used to run DevEco hvigor.js"),
                TKCommandSchemaOption(name: "--java-home", type: "Path", description: "JAVA_HOME used for DevEco JBR"),
                TKCommandSchemaOption(name: "--deveco-sdk-home", type: "Path", description: "DEVECO_SDK_HOME used for Harmony SDK discovery"),
                TKCommandSchemaOption(name: "--product", type: "String", description: "DevEco product name passed as -p product=<name>"),
                TKCommandSchemaOption(name: "--task", type: "String", description: "Harmony hvigor task, for example assembleHap or assembleApp"),
                TKCommandSchemaOption(name: "--no-daemon", type: "Bool", defaultValue: "false", description: "Pass --no-daemon to hvigor"),
            ...
            examples: [
                ...
                "triton build harmony --project /tmp/HarmonyApp --node /Applications/DevEco-Studio.app/Contents/tools/node/bin/node --hvigor /Applications/DevEco-Studio.app/Contents/tools/hvigor/hvigor/bin/hvigor.js --java-home /Applications/DevEco-Studio.app/Contents/jbr/Contents/Home --deveco-sdk-home /Applications/DevEco-Studio.app/Contents/sdk --task assembleApp --product default --mode debug --no-daemon --json",
            ],
            ...
            failureShape: "{ ok:false, error:{ code: validation_failed|invalid_workspace_path|ambiguous_workspace|scheme_not_found|device_not_ready|device_not_trusted|developer_mode_required|ddi_missing|xcode_signing_failed|provisioning_profile_missing|xcodebuild_failed|gradle_not_found|gradle_build_failed|apk_artifact_not_found|android_keystore_missing|android_signing_failed|hvigor_not_found|hvigor_build_failed|hap_artifact_not_found|harmony_certificate_missing|harmony_profile_missing, message, hint, nextAction?{ command,args,category,requiresLongRunningProcess?,readyEvents,finalEvents,terminationSignals } } }",
            ...
            subcommands: [
                ...
                TKCommandSubcommandSchema(
                    ...
                    requiredOptions: ["--project"],
                    optionalOptions: ["--module", "--mode", "--hvigor", "--node", "--java-home", "--deveco-sdk-home", "--product", "--task", "--no-daemon", "--output", "--timeout", "--jsonl", "--json"],
                    jsonlEvents: [
