    ...
    return [
        TKCommandSchema(
            ...
            options: hostPort + [
                ...
                TKCommandSchemaOption(name: "--node-id", type: "String", description: "Runtime hierarchy node id for patch-node, for example ios:runtime:<oid>"),
                TKCommandSchemaOption(name: "--view-oid", type: "UInt", description: "Runtime UIView oid for patch-node"),
                TKCommandSchemaOption(name: "--layer-oid", type: "UInt", description: "Runtime CALayer oid for patch-node"),
                TKCommandSchemaOption(name: "--patch", type: "JSON", description: "TKNodePropertyChanges JSON for patch-node"),
            ...
            outputContracts: [
                ...
                nodePropertyPatchOutputContract(),
            ...
            subcommands: [
                ...
                TKCommandSubcommandSchema(name: "patch-node", summary: "Apply a runtime node property patch", requiredOptions: ["--patch"], oneOfRequiredOptions: [["--node-id"], ["--oid"], ["--view-oid"], ["--layer-oid"]], optionalOptions: ["--target", "--device", "--host", "--port", "--node-id", "--oid", "--view-oid", "--layer-oid", "--format", "--json", "--language", "--lang"], outputSelectors: ["node.property-patch"], failureCodes: ["server_unavailable", "target_unavailable", "runtime_unavailable", "request_failed", "validation_failed"]),
