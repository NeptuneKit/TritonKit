    ...
    return [
        ...
        TKCommandSchema(
            ...
            options: [
                ...
                TKCommandSchemaOption(name: "--env", type: "KEY=VALUE", description: "Repeatable iOS Simulator launch environment for app launch; values are passed as SIMCTL_CHILD_* and redacted in sourceCommand"),
