    ...
    return [
        ...
        TKCommandSchema(
            ...
            options: [
                ...
                TKCommandSchemaOption(name: "--platform", type: "ios|harmony", description: "Host app platform filter; when omitted, install/launch/terminate/open-url infer the platform from the provided app identifiers"),
            ...
            nextCommands: [
                "triton app open-url <url> --wait-ready --snapshot --json",
                "triton status --json",
