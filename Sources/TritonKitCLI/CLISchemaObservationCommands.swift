...
func observationCommandSchemas() -> [TKCommandSchema] {
    ...
    return [
        ...
        TKCommandSchema(
            ...
            outputSemantics: "Use hierarchy for full raw view hierarchy inspection. Prefer snapshot/observe for bounded agent decisions, and use --output for evidence-friendly artifacts.",
        ...
        TKCommandSchema(
            ...
            artifacts: ["evidence-bundle", "manifest", "screenshots", "logs", "host-artifacts", "xcode-artifacts", "real-device.diagnostics", "host.app-action", "runtime.snapshot", "host.layout", "build.summary"],
            nextCommands: [
                "triton status --json",
        ...
        TKCommandSchema(
            ...
            artifacts: ["evidence-bundle", "manifest", "screenshots", "hierarchy", "ax", "geometry", "logs", "host-artifacts", "xcode-artifacts"],
            nextCommands: [
                "triton status --json",
                "triton evidence summary <dir.tritonevidence> --json",
                "triton evidence redact <dir.tritonevidence> --output <safe.tritonevidence> --json",
