...
func observationCommandSchemas() -> [TKCommandSchema] {
    ...
    return [
        ...
        TKCommandSchema(
            ...
            options: hostPort + [
                target,
                TKCommandSchemaOption(name: "--platform", type: "ios|android|harmony", description: "Return a platform-neutral hierarchy scene using iOS runtime AX, Android UIAutomator, or Harmony dumpLayout sources"),
            ...
            outputContracts: [hierarchyInfoOutputContract()],
