...
func observationCommandSchemas() -> [TKCommandSchema] {
    ...
    return [
        ...
        TKCommandSchema(
            ...
            failureShape: "{ ok:false, error:{ code: server_unavailable|target_unavailable|target_not_found|ambiguous_target|host_command_failed|validation_failed, message, hint, nextAction? }, candidates?[] }",
            outputSemantics: "Use observe to read native visible surface state across iOS embedded runtime and Harmony host layout before choosing tap, WebView, route, screenshot, or evidence commands.",
        ...
        TKCommandSchema(
            ...
            failureShape: "{ ok:false, error:{ code: server_unavailable|target_unavailable|target_not_found|ambiguous_target|node_not_found|hierarchy_unavailable|host_command_failed|validation_failed, message, endpoint, hint, nextAction? } }",
            outputSemantics: "Use node --oid for low-level hierarchy inspection and node resolve for current visible UI resolution across iOS runtime or Harmony host layout.",
            nextCommands: [
                "triton status --json",
                "triton attrs --oid <layerOid> --json",
            ...
            outputContracts: [hierarchyNodeOutputContract(), nodeResolveOutputContract()],
