...
func observationCommandSchemas() -> [TKCommandSchema] {
    ...
    return [
        ...
        TKCommandSchema(
            ...
            artifacts: ["evidence-bundle", "manifest", "screenshots", "logs", "host-artifacts", "xcode-artifacts"],
            nextCommands: [
                "triton status --json",
        ...
        TKCommandSchema(
            ...
            outputSemantics: "Use smoke for one-command real-project regression only after target, app, and runtime assumptions are known. Failed smoke runs should be followed by evidence summary or redaction.",
            artifacts: ["evidence-bundle", "screenshot", "harmony-layout"],
            nextCommands: [
                "triton assert text-exists <text> --json",
                "triton evidence summary <dir.tritonevidence> --json",
                "triton evidence redact <dir.tritonevidence> --output <safe.tritonevidence> --json",
