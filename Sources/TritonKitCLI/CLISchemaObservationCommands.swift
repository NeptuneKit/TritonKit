...
func observationCommandSchemas() -> [TKCommandSchema] {
    ...
    return [
        ...
        TKCommandSchema(
            ...
            nextCommands: [
                "triton status --json",
                "triton hierarchy --target <id> --json",
                "triton snapshot --target <id> --json",
                "triton evidence --target <id> --output <dir.tritonevidence> --json",
            ],
        ...
        TKCommandSchema(
            ...
            examples: [
                ...
                "triton evidence --include host,xcode --output /tmp/host-xcode.tritonevidence --json",
