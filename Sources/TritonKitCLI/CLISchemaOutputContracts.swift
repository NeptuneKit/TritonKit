...
func testRecorderSessionStartOutputContract() -> TKCommandOutputContract {
    TKCommandOutputContract(
        ...
        fields: schemaContractFields([
            ...
            ("manifest.capabilitiesRef", "String?", false, "Relative path to contract-capabilities.json"),
...
func testRecorderReplayRunOutputContract() -> TKCommandOutputContract {
    TKCommandOutputContract(
        ...
        fields: schemaContractFields([
            ...
            ("executor", "String?", false, "Replay executor identifier; currently local-simulated for offline contract execution"),
            ...
            ("execution.mode", "String?", false, "Execution mode, currently offline-simulated for local-simulated"),
            ...
            ("execution.networkPolicyMode", "String?", false, "not-present or simulated-projection for local-simulated Network Map handling"),
