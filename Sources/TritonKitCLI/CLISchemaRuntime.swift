...
func commandSchemas() -> [TKCommandSchema] {
    ...
    return [
        ...
        TKCommandSchema(
            ...
            outputFormats: jsonText,
            options: [
                TKCommandSchemaOption(name: "doctor --platform ios|harmony", type: "Subcommand", description: "Probe platform host tool availability"),
                TKCommandSchemaOption(name: "list --platform ios|harmony", type: "Subcommand", description: "List iOS Simulator or Harmony HDC targets with the same envelope"),
                ...
                TKCommandSchemaOption(name: "alias set <name> --platform ios|harmony --target <id>", type: "Subcommand", description: "Map a stable alias to an iOS UDID or Harmony HDC target"),
            ...
            providedCapabilities: ["host-device", "host-device-selector", "device-alias", "device-list", "device-use", "device-current", "device-resolve", "device-wait-ready", "device-screenshot", "ios-device", "harmony-device", "harmony-runtime-url", "harmony-device-stop"]
        ),
        TKCommandSchema(
            name: "sim",
        ...
        TKCommandSchema(
            ...
            options: [
                ...
                TKCommandSchemaOption(name: "--platform", type: "ios|harmony", description: "Host app platform filter; iOS remains the compatibility default when no device selector is provided"),
                ...
                TKCommandSchemaOption(name: "--state", type: "String", description: "Target state filter, for example booted or connected"),
                TKCommandSchemaOption(name: "--ready", type: "Bool", defaultValue: "false", description: "Only match ready host targets"),
                TKCommandSchemaOption(name: "--simulator", type: "String", description: "Compatibility iOS selector; cannot be combined with --device"),
        ...
        TKCommandSchema(
            ...
            successShape: "{ ok, action, platform, capturedAt, target, current?, candidates[], sources[], sourceCommands[], note } or { ok, action, platform, capturedAt, target, webView, sources[], sourceCommands[], note } or { ok, action:webview.current-url, platform, capturedAt, target, webViewID, url, title?, pageSessionID?, providerStatus, bridgeStatus } or { ok, action:webview.snapshot, capturedAt, platform, target, webView, include[], text[], dom[], forms[], links[], skipped[], truncation, redaction } or { ok, action, capturedAt, platform, target, webViewID, pageSessionID?, method, result?, elapsedMs, redaction } or { ok, action, capturedAt, platform, target, events[], limit }",
            ...
            providedCapabilities: ["webview-list", "webview-current", "webview-current-url", "webview-snapshot", "webview-bridge-call", "webview-events"]
        ),
        TKCommandSchema(
            name: "route",
        ...
        TKCommandSchema(
            ...
            options: hostPort + [
                ...
                TKCommandSchemaOption(name: "--include", type: "String", defaultValue: "status,list,version,hierarchy,ax,screenshot", description: "Comma-separated artifact kinds: status,list,version,hierarchy,ax,screenshot,geometry,archive,logs,host,xcode"),
        ...
        TKCommandSchema(
            ...
            options: hostPort + [
                ...
                TKCommandSchemaOption(name: "--include", type: "String", defaultValue: "status,list,version,hierarchy,ax,screenshot,geometry,archive", description: "Comma-separated artifact kinds: status,list,version,hierarchy,ax,screenshot,geometry,archive,logs,host,xcode"),
                TKCommandSchemaOption(name: "--note", type: "String", description: "Human note stored in manifest"),
                TKCommandSchemaOption(name: "--xcode-summary", type: "Path", description: "Explicit TKXcodeActionSummary JSON to import when --include contains xcode"),
                TKCommandSchemaOption(name: "--refresh/--no-refresh", type: "Bool", defaultValue: "true", description: "Request fresh hierarchy before hierarchy/archive capture"),
                TKCommandSchemaOption(name: "--format", type: "text|json", defaultValue: "json", description: "Output format"),
        ...
        TKCommandSchema(
            ...
            options: [
                ...
                TKCommandSchemaOption(name: "--target", type: "String", description: "Target id for iOS runtime or compatibility Harmony hdc target; Harmony --target cannot be combined with --device"),
