...
func commandSchemas() -> [TKCommandSchema] {
    ...
    return [
        ...
        TKCommandSchema(
            ...
            providedCapabilities: ["host-device", "host-device-selector", "device-alias", "device-list", "device-use", "device-current", "device-resolve", "device-wait-ready", "device-screenshot", "ios-device", "harmony-device", "harmony-runtime-url"]
        ),
        TKCommandSchema(
            name: "sim",
