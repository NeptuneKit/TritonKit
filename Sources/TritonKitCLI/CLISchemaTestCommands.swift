    ...
    [
        TKCommandSchema(
            ...
            usageForms: [
                ...
                TKCommandUsageForm(form: "reliability-sample --collection-receipt <private-root/collection-receipt.json> --flow flow_001 --slot 1 --reset-receipt <private.json> --target <canonical> --host 127.0.0.1 --port 19421 --confirm --json", kind: "Subcommand", description: "Claim one new slot and run its receipt-frozen normalized plan; no implicit server, Simulator, reset, App lifecycle, or retries"),
            ...
            examples: [
                ...
                "triton test reliability-sample --collection-receipt ./private-root/collection-receipt.json --flow flow_001 --slot 1 --reset-receipt ./private-reset-receipt.json --target <canonical> --host 127.0.0.1 --port 19421 --confirm --json",
