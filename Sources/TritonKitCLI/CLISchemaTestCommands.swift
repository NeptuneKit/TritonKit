    ...
    [
        TKCommandSchema(
            ...
            examples: [
                ...
                "triton test reliability-sample --collection-receipt ./private-root/collection-receipt.json --expect-receipt-sha256 <64-lowercase-hex> --flow flow_001 --slot 1 --reset-receipt ./private-reset-receipt.json --target <canonical> --host 127.0.0.1 --port 19421 --confirm --json",
