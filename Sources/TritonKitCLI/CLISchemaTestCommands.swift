...
func testCommandSchemas() -> [TKCommandSchema] {
    [
        TKCommandSchema(
            name: "test",
            summary: "Validate, normalize, and execute deterministic .tritontest.yaml contracts",
            requiresServer: false,
            requiresTarget: false,
            runtimeScope: "offline for validate/normalize/report/create; runtime target required for run",
            exitCodeOnFailure: 1,
            ...
            options: [
                ...
                TKCommandSchemaOption(name: "--output", type: "Path", description: "Required for create; output .tritontest.yaml file"),
            ...
            providedCapabilities: ["test-validate", "test-normalized-plan", "test-run-minimal", "test-run-deterministic", "test-run-vlm-assisted", "test-run-ai-mock", "test-report", "test-create-from-session"]
        ),
    ]
}
