        ...
        TKCommandSchema(
            ...
            subcommands: [
                TKCommandSubcommandSchema(
                    ...
                    optionalOptions: ["--target", "--platform", "--scope", "--runs-dir", "--run-id", "--action-policy", "--max-steps", "--allowed-action", "--stop-condition", "--observation-fixture", "--llm-provider", "--vlm-provider", "--dry-model-fixture", "--format", "--json"],
