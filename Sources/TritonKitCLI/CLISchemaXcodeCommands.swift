    ...
    return [
        TKCommandSchema(
            ...
            options: [
                ...
                TKCommandSchemaOption(name: "--build-setting", type: "KEY=VALUE[]", description: "Repeatable one-off xcodebuild setting for settings/build/test/archive/export/run; keys must match [A-Za-z_][A-Za-z0-9_]* and each full KEY=VALUE is preserved as one argv element and exposed in sourceCommand"),
