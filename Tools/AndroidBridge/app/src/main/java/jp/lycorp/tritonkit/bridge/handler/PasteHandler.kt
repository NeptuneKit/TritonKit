...
package jp.lycorp.tritonkit.bridge.handler
 ...
 *
 * Mirrors the iOS `TritonKit paste` semantics: place text on the system
...
class PasteHandler {
    ...
    fun paste(
        ...
        // text clipboards (rare for TritonKit callers — text is
    ...
    companion object {
        private const val TAG = "TritonKitPaste"
        private const val CLIP_LABEL = "TritonKit"
    }
}