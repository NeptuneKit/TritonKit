...
import jp.lycorp.tritonkit.bridge.server.ActionRouter
import jp.lycorp.tritonkit.bridge.server.HttpServer

/**
 * TritonKit bridge accessibility service.
 *
 * Owns:
 ...
 */
class TritonKitAccessibilityService : AccessibilityService() {
    ...
    companion object {
        private const val TAG = "TritonKitA11yService"
        const val SERVER_PORT = 8080

        @Volatile
        var instance: TritonKitAccessibilityService? = null
            private set
    }
}