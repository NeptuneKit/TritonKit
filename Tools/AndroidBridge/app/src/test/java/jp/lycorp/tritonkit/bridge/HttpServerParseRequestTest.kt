...
class HttpServerParseRequestTest {
    ...
    private fun mockRouter() = jp.lycorp.tritonkit.bridge.server.ActionRouter(
        serviceProvider = { null },
        authManager = mockAuthManager()
    )

    private fun mockAuthManager() = io.mockk.mockk<jp.lycorp.tritonkit.bridge.config.AuthManager>(relaxed = true)
