...
package jp.lycorp.tritonkit.bridge

import android.net.Uri
import android.os.Binder
import jp.lycorp.tritonkit.bridge.service.TritonKitContentProvider
...
/**
 * Verifies that [TritonKitContentProvider] enforces shell/root caller UID.
 *
 ...
 */
class TritonKitContentProviderTest {
    ...
    fun queryRejectsArbitraryAppUid() {
        ...
        TritonKitContentProvider().query(authTokenUri, null, null, null, null)
    }

    @Test(expected = SecurityException::class)
    fun insertRejectsArbitraryAppUid() {
        every { Binder.getCallingUid() } returns 10042
        TritonKitContentProvider().insert(toggleUri, null)
    }
