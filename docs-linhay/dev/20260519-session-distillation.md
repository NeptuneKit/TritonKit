...
1. `triton` CLI 包：`triton-macos-<arch>.tar.gz`
2. 项目级 skill 合并包：`tritonkit-skills.tar.gz`，当前至少包含 `tritonkit-dev-feedback`、`tritonkit-real-project-regression` 与 `tritonkit-emulator-cli-takeover`
