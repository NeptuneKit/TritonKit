...
- And `Examples/TritonKitDemo` 的 `Camera` 场景暴露 `CameraHarnessStatus`、`CameraHarnessFrameCount`、`CameraHarnessPreview` 和 `CameraHarnessPreviewImage`，可用于自动化验证相机状态、帧计数和 preview 渲染
