...
- Atlas 已能在 bounded recovery loop 中写多 screen/state/transition delta，例如 `screen_0000 -> screen_0001 -> screen_0002` 和 `transition_0000/0001`；仍未完成的是完整 Atlas map 的 state variant 合并、coverage path 或 app-map merge。
- 未做 Web Workbench 视图。
