...
| `SP-158-issue-196-xcode-archive-export` | [`SP-158-issue-196-xcode-archive-export`](./SP-158-issue-196-xcode-archive-export/README.md) | 执行 | 规范目录；#196 archive 与 IPA export workflow 实现中，尚未 push/merge/关闭 |
