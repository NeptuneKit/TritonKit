...
| `SP-151-trusted-baseline-integration` | [`SP-151-trusted-baseline-integration`](./SP-151-trusted-baseline-integration/README.md) | 已完成（本地） | 规范目录；已在隔离 worktree 汇集 SP-142～150 并完成离线验证与 docs 收口；source branch/worktree 已回收，不改 main、不触碰 #164 或真实运行环境 |
