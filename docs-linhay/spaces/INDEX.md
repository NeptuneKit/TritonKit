...
| 项目 | 进度 | 说明 |
| --- | --- | --- |
| 编号登记 | 153/153 | 所有当前 space 均已分配唯一 SP 编号 |
| README 链接核对 | 153/153 | 每条记录链接到现有 space README |
| 历史目录物理迁移 | 0/125 | 125 个历史兼容目录留待独立迁移批次；SP-126～153 已是规范目录 |
