...
| `SP-159-issue-195-ios-ddi-recovery` | [`SP-159-issue-195-ios-ddi-recovery`](./SP-159-issue-195-ios-ddi-recovery/README.md) | 执行 | 规范目录；#195 仅实现 `ddi_missing` 的可执行 app-install recovery，真实 DDI/tunnel smoke 待设备与授权 |
