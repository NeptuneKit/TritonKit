...
| `SP-127-issue-168-ios-real-device-terminate-pid` | [`SP-127-issue-168-ios-real-device-terminate-pid`](./SP-127-issue-168-ios-real-device-terminate-pid/README.md) | 已完成（本地） | 规范目录；checkpoint 已经由 `d0f09d3c` 进入本地 main，真机 smoke blocker 继续隔离 |
| `SP-128-issue-167-xcode-device-alias-preflight` | [`SP-128-issue-167-xcode-device-alias-preflight`](./SP-128-issue-167-xcode-device-alias-preflight/README.md) | 已完成（本地） | 规范目录；checkpoint 已经由 `d0f09d3c` 进入本地 main，真实 Xcode/device 覆盖缺口保留 |
...
| `SP-130-issue-166-runtime-jpeg-normalization` | [`SP-130-issue-166-runtime-jpeg-normalization`](./SP-130-issue-166-runtime-jpeg-normalization/README.md) | 已完成（本地） | 规范目录；JPEG->PNG fixture/release/schema 已经由 `d0f09d3c` 进入本地 main；#164 WIP 继续隔离 |
...
| `SP-151-trusted-baseline-integration` | [`SP-151-trusted-baseline-integration`](./SP-151-trusted-baseline-integration/README.md) | 已完成（总集成候选） | 规范目录；SP-142～156 已在隔离 integration branch 汇集，联合 focused、local 总门禁与 156/156 docs gate 通过，待 PR/CI |
| `SP-152-issue-172-runtime-reregistration` | [`SP-152-issue-172-runtime-reregistration`](./SP-152-issue-172-runtime-reregistration/README.md) | 已完成（总集成候选） | 规范目录；embedded WebSocket connection generation、legacy SDK compatibility 与 no-target doctor diagnostics 已进入 SP-151 |
| `SP-153-issue-173-xcode-run-target-binding` | [`SP-153-issue-173-xcode-run-target-binding`](./SP-153-issue-173-xcode-run-target-binding/README.md) | 已完成（总集成候选） | 规范目录；#173 单目标绑定已进入 SP-151，待 PR/CI |
| `SP-154-issue-174-simulator-swipe-lifecycle` | [`SP-154-issue-174-simulator-swipe-lifecycle`](./SP-154-issue-174-simulator-swipe-lifecycle/README.md) | 已完成（总集成候选） | 规范目录；#174 persistent Baguette input、逐事件 ack 与 terminal linger 已进入 SP-151，待 PR/CI |
| `SP-155-issue-175-ios-readiness-coredevice` | [`SP-155-issue-175-ios-readiness-coredevice`](./SP-155-issue-175-ios-readiness-coredevice/README.md) | 已完成（总集成候选） | 规范目录；available-paired readiness、fail-closed blockers 与同源 install plan 已进入 SP-151，待 PR/CI |
| `SP-156-issue-176-xcode-compact-progress` | [`SP-156-issue-176-xcode-compact-progress`](./SP-156-issue-176-xcode-compact-progress/README.md) | 已完成（总集成候选） | 规范目录；#176 默认 compact、显式 full 的 Xcode build progress 合同已进入 SP-151，待 PR/CI |
