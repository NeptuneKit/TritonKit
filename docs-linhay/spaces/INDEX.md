...
> 最近同步：2026-07-28
> 覆盖范围：141/141 个当前 branch 可见 space（SP-141 local checkpoint 待按顺序集成）
...
| 项目 | 进度 | 说明 |
| --- | --- | --- |
| 编号登记 | 141/141 | 当前 branch 可见 space 均已登记；SP-141 checkpoint 未进入本 branch，docs gate 必须待 SP-141 → SP-142 顺序集成后恢复连续 |
| README 链接核对 | 141/141 | 每条当前 branch 可见目录均链接到现有 space README |
| 历史目录物理迁移 | 0/125 | 125 个历史兼容目录留待独立迁移批次；SP-126～140、SP-142 已是规范目录 |
