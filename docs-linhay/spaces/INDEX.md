...
| 项目 | 进度 | 说明 |
| --- | --- | --- |
| 编号登记 | 160/160 | 所有当前 space 均已分配唯一 SP 编号 |
| README 链接核对 | 160/160 | 每条记录链接到现有 space README |
...
| `SP-160-issue-197-harmony-wait-budget` | [`SP-160-issue-197-harmony-wait-budget`](./SP-160-issue-197-harmony-wait-budget/README.md) | 执行 | #197 Harmony wait 在剩余预算低于 0.4 秒时停止启动 layout capture；待分支全量门禁、主线 CI 与 issue 收口 |
