...
| 状态 | Space | 裁决 | 下一步 |
| --- | --- | --- | --- |
| 执行 | [20260720-issue-146-sim-record-duration](./20260720-issue-146-sim-record-duration/README.md) | 修复 `sim record` 对截断 MOV 仍返回成功的问题，并补 actual duration 契约 | BDD/TDD、真实 Simulator 录屏 smoke、合入后关闭 #146 |
