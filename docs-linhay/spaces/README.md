...
| 已归档 | [20260722-issue-162-ios-real-device-launch-resolution](./20260722-issue-162-ios-real-device-launch-resolution/README.md) | 显式 iOS 真机 selector 的 install/info/launch 已共享 live resolution；真实不可用设备稳定返回 `target_offline` 与结构化恢复动作 | `f263c399` 已合并，CI `29927019645` 通过，GitHub #162 已关闭 |
| 已归档 | [20260722-issue-163-xcresult-array-decoding](./20260722-issue-163-xcresult-array-decoding/README.md) | xcresult decoder 已兼容历史 singleton、Xcode 26.6 summary arrays 与 flattened failed test cases | `938f9640` 已合并，CI `29929843919` 通过，GitHub #163 已关闭 |
