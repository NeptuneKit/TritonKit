...
| 待发布（v0.2.16） | [SP-141-packaged-web-simulator-input](./SP-141-packaged-web-simulator-input/README.md) | packaged `/web/host-input` 已按 iOS real runtime mirror、三平台 host target 与 unsupported 三路分流，不再错拒 Simulator | Swift focused 27、Web 82/build 与真实 Simulator HTTP/Playwright smoke 通过；版本入口已对齐 0.2.16 |
