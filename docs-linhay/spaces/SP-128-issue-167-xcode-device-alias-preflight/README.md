...
- 第二轮窄 TDD 已验证 `XcodeCommandTests` 21/21、`FailureDiagnosticsTests` 13/13；schema broader suite 的既有 device proxy、sim app-console、device 参数/selector contract failures 未纳入本 slice。
